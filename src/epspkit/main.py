...
from epspkit.template import build_and_fit_template
from epspkit.plotting import plot_trace, plot_io_curve
...
def main() -> None:
    ...
    ca1_results.add("result_fv", build_and_fit_template(
    ...
    ca1_results.add("result_fepsp", build_and_fit_template(
        train_df=ca1_prep_train, test_df=ca1_prep_test, 
    ...
    dg_results.add("result_fv", build_and_fit_template(
        train_df=dg_prep_train, test_df=dg_prep_test, 
        template_window=(1.0, 2.5), search_window=(0.5, 4.0), 
        template_intensities=template_ints, slope_transform=False
    ))
    
    dg_results.add("result_fepsp", build_and_fit_template(
        train_df=dg_prep_train, test_df=dg_prep_test, 
        template_window=(3.0, 4.7), search_window=(2.5, 10.0), 
        template_intensities=template_ints, slope_transform=True
    ))
